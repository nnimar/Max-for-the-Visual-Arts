...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 227.0, 111.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 162.5, 211.0, 22.0 ],
					"text" : "use with Processing (see below)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 128.5, 205.0, 22.0 ],
					"text" : "use with OSCeleton application"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 162.5, 153.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 158.5, 79.0, 17.0 ],
					"rounded" : 20.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 162.5, 150.0, 17.0 ],
					"text" : "load Kinect-Via-Processing"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 59.5, 137.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 216.5, 79.0, 17.0 ],
					"rounded" : 20.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 59.5, 137.0, 17.0 ],
					"text" : "load Kinect-Via-Synapse"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 128.5, 152.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 180.5, 79.0, 17.0 ],
					"rounded" : 20.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 132.5, 149.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 191.0, 55.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 97.5, 130.0, 17.0 ],
					"text" : "load Kinect-Via-NIMate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 28.0, 384.0, 20.0 ],
					"text" : "here are a few more option to visualise the skeletons from the Kinect",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 2.0, 305.0, 30.0 ],
					"text" : "Jon Bellona's Kinect helpers",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 3.0, 438.0, 46.0 ],
