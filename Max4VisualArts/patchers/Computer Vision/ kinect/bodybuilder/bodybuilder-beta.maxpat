...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 225.0, 205.0, 67.0, 20.0 ],
					"text" : "route dt sv"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 231.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 275.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 258.0, 46.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 193.0, 300.0, 85.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 200.0, 151.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 197.0, 279.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 173.0, 178.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.0, 268.0, 50.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 3.25, 293.0, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 293.0, 501.0, 93.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 501.5, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 503.0, 102.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 501.0, 111.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 488.5, 398.0, 38.0 ],
					"text" : ";\rmax launchbrowser \\\"file:////Applications/Max6/examples/IMIpatches/Plugins_kinect/Synapse/Synapse.app\\\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 28.0, 399.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 158.0, 61.0, 20.0 ],
					"text" : "r thebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 145.0, 63.0, 20.0 ],
					"text" : "s thebang"
				}
...
,
					"patching_rect" : [ 9.0, 232.0, 102.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.574097, 257.638458, 128.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 343.0, 107.0, 18.0 ],
					"text" : "5 left"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 147.0, 125.0, 98.0, 20.0 ],
					"text" : "route v1 v2 v3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 147.0, 82.0, 169.0, 20.0 ],
					"text" : "route autobora"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 378.0, 281.0, 40.0, 20.0 ],
					"text" : "sel -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 310.0, 55.0, 20.0 ],
					"text" : "pack 0 s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 147.0, 203.0, 46.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 236.0, 175.0, 85.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 378.0, 248.0, 127.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 385.0, 426.0, 127.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
					"text" : "coll samplemapper.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 378.0, 216.0, 76.0, 20.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 445.0, 415.0, 46.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 392.0, 415.0, 46.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 338.0, 388.0, 126.0, 20.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 297.0, 446.0, 216.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 181.0, 125.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 114.0, 94.0, 20.0 ],
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 126.0, 84.0, 20.0 ],
					"text" : "prepend body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 297.0, 190.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 57.0, 106.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 55.0, 135.147247, 229.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 1.0, 519.0, 49.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 93.5, 173.0, 18.5, 173.0 ],
					"source" : [ "obj-18", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 399.5, 521.75, 114.5, 521.75 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 408.5, 335.0, 497.5, 335.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 306.5, 113.5, 306.5, 113.5 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 347.0, 228.0, 347.5, 228.0 ],
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "bodybuilder.js",
				"bootpath" : "/Applications/Max6/examples/IMIpatches/Computer Vision/ kinect/bodybuilder",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "samplemapper.txt",
				"bootpath" : "/Applications/Max6/examples/IMIpatches/Computer Vision/ kinect/bodybuilder",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
