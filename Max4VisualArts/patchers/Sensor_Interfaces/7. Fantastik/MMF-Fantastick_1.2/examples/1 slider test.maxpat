...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 29.0, 55.0, 20.0, 20.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 62.0, 181.0, 195.0, 33.0 ],
									"text" : "this slider is named \"slider1\"\nand is visible in presentation mode"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 151.0, 32.0, 129.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 29.0, 77.0, 55.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
,
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/mathieuchamagne/Dropbox/_Max_/mc_patches-max5/MMF_googleCode/trunk/MMF-Fantastick_1.2/abstractions",
