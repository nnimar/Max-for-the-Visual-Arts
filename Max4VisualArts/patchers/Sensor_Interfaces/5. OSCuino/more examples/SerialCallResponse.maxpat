...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 135.0, 569.0, 34.0, 95.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.0, 535.0, 237.0, 22.0 ],
					"text" : "o.route /0/u /1 /2 /3 /4 /5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 186.0, 39.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 170.0, 53.0, 20.0 ],
					"presentation_rect" : [ 126.0, 170.0, 0.0, 0.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 774.0, 162.0, 150.0, 20.0 ],
					"text" : "/analog/{0,3}/u",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 777.5, 97.0, 222.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 757.5, 96.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 757.5, 127.0, 86.0, 22.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 159.0, 150.0, 20.0 ],
					"text" : "/analog/[0-3]/u",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.5, 158.0, 150.0, 20.0 ],
					"text" : "/analog/*",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.0, 531.0, 447.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "FullPacket" ],
					"patching_rect" : [ 16.0, 323.0, 221.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 483.5, 82.0, 187.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.5, 95.0, 180.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 249.0, 150.0, 69.0 ],
					"text" : "/analog/0 1019\n/analog/1 1018\n/analog/2 1018\n/analog/3 1017",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.0, 199.0, 150.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 184.0, 78.0, 20.0 ],
					"text" : "diagnose"
				}
...
,
					"patching_rect" : [ 560.5, 42.0, 111.0, 22.0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../../Applications/Max 6.1/packages/IMIpatches/externals/sound/CNMAT_Externals/odot/abstractions/io",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
