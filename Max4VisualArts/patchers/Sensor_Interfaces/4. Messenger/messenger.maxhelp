...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 1.0, -3.0, 486.0, 55.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 275.0, 122.0, 35.0 ],
					"style" : "",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/Shared/Max 7/Packages/IMIpatches/patchers/Sensor_Interfaces/4. Messenger",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
