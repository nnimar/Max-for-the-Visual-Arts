...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.0, 60.0, 83.0, 18.0 ],
					"text" : "getnumberVal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 603.0, 109.0, 34.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.0, 146.0, 118.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 587.0, 175.0, 45.0, 20.0 ],
					"varname" : "numberVal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 562.0, 83.0, 59.5, 20.0 ],
					"restore" : 					{
						"numberVal" : [ 10.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 453.0, 79.0, 20.0 ],
					"text" : "print settings"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 580.0, 363.0, 37.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 400.0, 57.0, 20.0 ],
					"text" : "s pattr-in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 363.0, 19.0, 19.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 621.0, 363.0, 19.0, 19.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 733.0, 363.0, 50.0, 19.0 ],
					"text" : "store 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.0, 363.0, 50.0, 19.0 ],
					"text" : "store 1"
				}
...
,
					"patching_rect" : [ 562.0, 230.0, 86.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 243.0, 55.0, 20.0 ],
					"text" : "r pattr-in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 75.0, 390.0, 24.0, 20.0 ],
					"text" : "t b",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 365.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 341.0, 65.0, 20.0 ],
					"text" : "s pattr-out",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.5, 170.5, 91.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.5, 242.0, 65.0, 18.0 ],
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 111.0, 98.5, 60.0, 20.0 ],
					"text" : "loadbang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 215.0, 128.5, 60.0, 20.0 ],
					"text" : "loadbang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 90.5, 219.0, 65.0, 20.0 ],
					"text" : "closebang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 182.25, 182.5, 51.5, 20.0 ],
					"text" : "int",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 153.5, 54.5, 20.0 ],
					"text" : "int",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 182.25, 98.5, 24.0, 20.0 ],
					"text" : "t b",
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.411765, 0.411765, 0.411765, 0.5 ],
					"fontname" : "Gill Sans",
					"fontsize" : 13.74338,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "write" ],
					"patching_rect" : [ 352.5, 98.5, 43.0, 20.0 ],
					"text" : "t write",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "read" ],
					"patching_rect" : [ 280.5, 98.5, 41.0, 20.0 ],
					"text" : "t read",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 182.5, 85.0, 20.0 ],
					"text" : "prepend store",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 75.0, 123.5, 24.0, 20.0 ],
					"text" : "t b",
					"varname" : "u789009280"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 274.0, 112.0, 60.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.5, 67.0, 64.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 87.0, 11.5, 66.0, 27.0 ],
					"text" : "export",
					"textcolor" : [ 0.6, 0.6, 0.6, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.25, 67.0, 56.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 188.5, 11.5, 56.0, 27.0 ],
					"text" : "recall",
					"textcolor" : [ 0.6, 0.6, 0.6, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 67.0, 54.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 285.5, 11.5, 51.0, 27.0 ],
					"text" : "save",
					"textcolor" : [ 0.6, 0.6, 0.6, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.5, 67.0, 64.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 11.5, 66.0, 27.0 ],
					"text" : "import",
					"textcolor" : [ 0.6, 0.6, 0.6, 1.0 ]
				}
