...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ -1.5, 0.0, 437.0, 53.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"id" : "obj-30",
					"items" : [ "SparkFun-BT-COM0", ",", "BTGPS74R-SPP-1", ",", "Bluetooth-Incoming-Port" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 139.0, 396.0, 156.0, 19.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 69.0, 107.0, 22.0 ],
					"style" : "",
					"text" : "channels 1-512"
				}
