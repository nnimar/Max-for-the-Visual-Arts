...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 497.0, 50.0, 20.0 ],
					"presentation_rect" : [ 300.0, 458.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 72.0, 426.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 32.0, 130.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 466.5, 139.0, 20.0 ],
					"text" : "count received numbers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 120.0, 317.0, 56.0 ],
					"text" : "\"bang\" message to 'itable' will output a random adress, where adresses with higher Y values have a bigger probabiltiy of occurrence. See 'bang' and 'quantile' messages in 'itable reference'. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 53.0, 120.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 612.0, 112.0, 78.0 ],
					"text" : "iterated distribution according to user's function (upper table)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 282.5, 134.0, 24.0 ],
					"text" : "user drawn function "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.5, 42.0, 276.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 10.0, 124.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 10.0, 169.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 426.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 536.0, 270.0, 230.0 ],
					"range" : 300,
					"size" : 70,
					"table_data" : [ 0, 38, 28, 37, 40, 54, 65, 59, 54, 62, 70, 83, 79, 76, 98, 102, 104, 97, 98, 116, 120, 124, 131, 117, 132, 141, 141, 153, 148, 137, 123, 152, 161, 154, 150, 156, 140, 135, 150, 154, 139, 142, 147, 161, 139, 149, 138, 148, 156, 137, 136, 166, 155, 181, 174, 209, 204, 243, 233, 15, 14, 17, 11, 3, 3, 1, 4, 1, 0, 1, 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 53.0, 465.5, 36.0, 20.0 ],
					"text" : "histo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 186.0, 270.0, 230.0 ],
					"range" : 300,
					"size" : 70,
					"table_data" : [ 0, 37, 39, 44, 47, 53, 57, 61, 65, 72, 76, 80, 84, 91, 95, 99, 103, 107, 113, 116, 119, 122, 127, 130, 133, 136, 140, 142, 144, 145, 147, 150, 151, 152, 153, 154, 154, 155, 156, 156, 156, 156, 156, 156, 156, 156, 156, 156, 156, 154, 154, 169, 177, 185, 193, 214, 227, 239, 252, 20, 16, 12, 8, 4, 3, 3, 2, 2, 1, 1, 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 103.0, 60.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 53.0, 90.5, 69.0, 20.0 ],
					"text" : "metro 10"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.5, 525.25, 313.5, 525.25 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.5, 455.25, 62.5, 455.25 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.5, 512.5, 62.5, 512.5 ],
					"source" : [ "obj-20", 0 ]
				}
