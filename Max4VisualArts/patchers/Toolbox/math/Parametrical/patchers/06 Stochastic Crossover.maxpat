...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 40.0, 276.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 616.5, 6.0, 124.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 163.5, 351.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.5, 376.0, 55.0, 17.0 ],
					"text" : "points $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 233.5, 351.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 233.5, 376.0, 73.0, 18.0 ],
					"text" : "mutation $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.5, 306.0, 77.0, 35.0 ],
					"text" : "generate \noffspring"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.5, 190.0, 99.0, 35.0 ],
					"text" : "set parent A alleles "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.0, 190.0, 101.0, 35.0 ],
					"text" : "set parent B alleles "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 83.5, 309.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.25, 30.0, 426.0, 123.0 ],
					"text" : "Create new offspring lists from two parent lists. This algorithm features: mutation ratio, mix ratio from each parent, different list sizes, floats, ints and symbols, as well as the number of crossover points, allowing lists to be crossed over in chunks of list elements with a certain length.  \n\nThe important thing about the genetic algorithms is that they generate data according  to their ancestors' alleles, thus maintaining resemblances from their \"father\" and \"mother\"."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.25, 8.0, 315.25, 22.0 ],
					"text" : "GA (Crossover)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 460.0, 137.75, 21.0 ],
					"text" : "Offspring"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 172.0, 191.0, 21.0 ],
					"text" : "Parent B (mom)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.5, 172.0, 98.0, 21.0 ],
					"text" : "Parent A (dad)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 133.0, 481.0, 223.0, 95.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 30
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 363.0, 190.0, 223.0, 95.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 30
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 132.5, 190.0, 223.0, 95.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.0, 290.0, 61.0, 19.0 ],
					"text" : "prepend B"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.5, 290.0, 61.0, 19.0 ],
					"text" : "prepend A"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.5, 431.0, 100.0, 20.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 173.0, 413.5, 142.0, 413.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 93.0, 346.5, 142.0, 346.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 243.0, 422.5, 142.0, 422.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 372.5, 327.5, 142.0, 327.5 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Applications/Max 6.1/packages/IMIpatches/patchers/Toolbox/math/getParametrical/dependencies/o.list.crossover",
				"patcherrelativepath" : "../../dependencies/o.list.crossover",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
