...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "mai points (masato tsutsui)", "a GLmesh case study" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
,
					"patching_rect" : [ 361.0, 105.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 361.0, 132.0, 125.0, 35.0 ],
					"style" : "",
					"text" : "jit.window mai_points @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 148.0, 141.0, 49.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 538.0, 125.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 366.0, 39.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"tricolor" : [ 0.960784, 0.827451, 0.156863, 1.0 ],
					"triscale" : 0.9
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 512.0, 120.0, 22.0 ],
					"pattrmode" : 1,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 53.0, 568.0, 383.0, 49.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 30.0, 625.0, 383.0, 49.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 340.0, 233.0, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 9.0, 17.0, 61.0, 20.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 9.0, 96.0, 317.0, 20.0 ],
									"style" : "",
									"text" : "jit.rota @anchor_x 120 @anchor_y 120 @theta 1.570796"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 9.0, 51.0, 256.0, 33.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 382.0, 179.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 14.0,
...
, 						{
							"number" : 2,
							"data" : [ 5, "obj-25", "flonum", "float", 7.75, 5, "obj-22", "number", "int", 1000, 5, "obj-21", "umenu", "int", 31, 5, "obj-19", "number", "int", 30, 5, "obj-7", "umenu", "int", 0, 5, "obj-5", "number", "int", 90, 5, "obj-1", "number", "int", 5000 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-25", "flonum", "float", 4.7, 5, "obj-22", "number", "int", 729, 5, "obj-21", "umenu", "int", 31, 5, "obj-19", "number", "int", 95, 5, "obj-7", "umenu", "int", 2, 5, "obj-5", "number", "int", 84, 5, "obj-1", "number", "int", 5000 ]
						}
, 						{
							"number" : 4,
							"data" : [ 5, "obj-25", "flonum", "float", 4.49, 5, "obj-22", "number", "int", 500, 5, "obj-21", "umenu", "int", 31, 5, "obj-19", "number", "int", 62, 5, "obj-7", "umenu", "int", 4, 5, "obj-5", "number", "int", 34, 5, "obj-1", "number", "int", 5000 ]
						}
, 						{
							"number" : 6,
							"data" : [ 5, "obj-25", "flonum", "float", 7.75, 5, "obj-22", "number", "int", 500, 5, "obj-21", "umenu", "int", 28, 5, "obj-19", "number", "int", 68, 5, "obj-7", "umenu", "int", 0, 5, "obj-5", "number", "int", 68, 5, "obj-1", "number", "int", 5000 ]
						}
, 						{
							"number" : 7,
							"data" : [ 5, "obj-25", "flonum", "float", 6.0, 5, "obj-22", "number", "int", 729, 5, "obj-21", "umenu", "int", 28, 5, "obj-19", "number", "int", 95, 5, "obj-7", "umenu", "int", 2, 5, "obj-5", "number", "int", 84, 5, "obj-1", "number", "int", 2000 ]
						}
, 						{
							"number" : 8,
							"data" : [ 5, "obj-25", "flonum", "float", 6.0, 5, "obj-22", "number", "int", 500, 5, "obj-21", "umenu", "int", 28, 5, "obj-19", "number", "int", 62, 5, "obj-7", "umenu", "int", 4, 5, "obj-5", "number", "int", 51, 5, "obj-1", "number", "int", 2000 ]
						}
 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 30.0, 305.0, 204.0, 22.0 ],
					"style" : "",
					"text" : "jit.slide @slide_up 5 @slide_down 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.0, 218.0, 39.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"tricolor" : [ 0.960784, 0.827451, 0.156863, 1.0 ],
					"triscale" : 0.9
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 243.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "dim $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, 218.0, 162.0, 22.0 ],
					"pattrmode" : 1,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 82.0, 194.0, 48.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"tricolor" : [ 0.960784, 0.827451, 0.156863, 1.0 ],
					"triscale" : 0.9
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 51.0, 218.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "/ 500."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 51.0, 166.0, 148.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 218.0, 42.0, 22.0 ],
					"style" : "",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"tricolor" : [ 0.960784, 0.827451, 0.156863, 1.0 ],
					"triscale" : 0.9
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 243.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "weight $1 $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 242.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "prepend basis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 243.0, 136.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 128.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "t b b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 712.0, 60.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 59.0, 35.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 8.0, 102.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 681.0, 292.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 56.0, 168.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.0, 73.0, 80.0, 20.0 ],
					"style" : "",
					"text" : "http://adsr.jp",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 408.0, 74.0, 72.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 58.0, 190.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 73.0, 711.0, 322.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 99.0, 134.147247, 72.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 253.5, 354.0, 253.5, 354.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 39.5, 506.0, 62.5, 506.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 199.5, 269.0, 39.5, 269.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 270.5, 269.0, 39.5, 269.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 398.5, 269.0, 39.5, 269.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 60.5, 269.0, 39.5, 269.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 82.5, 158.0, 17.5, 158.0 ],
					"source" : [ "obj-30", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 435.166656, 90.0, 306.5, 90.0 ],
					"source" : [ "obj-38", 1 ]
				}
