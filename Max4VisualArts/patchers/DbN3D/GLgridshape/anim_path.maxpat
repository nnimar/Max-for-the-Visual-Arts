...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "animation w/ jit.path (Peter Elsea)", "from notes on animation in Jitter" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 206.5, 74.0, 22.0 ],
					"style" : "",
					"text" : "calchandles"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 214.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 232.0, 138.0, 22.0 ],
					"style" : "",
					"text_width" : 82.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 368.0, 262.5, 59.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 98.0, 107.0, 102.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 157.0, 252.0, 59.5, 22.0 ],
					"style" : "",
					"text" : "jit.path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.0, 214.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "eval $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 157.0, 185.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 157.0, 156.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 157.0, 124.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "counter 0 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 66.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.0, 97.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 5.0, 284.0, 102.0, 35.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 5.0, 257.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 184.0, 303.5, 116.5, 76.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 278.5, 99.0, 22.0 ],
					"style" : "",
