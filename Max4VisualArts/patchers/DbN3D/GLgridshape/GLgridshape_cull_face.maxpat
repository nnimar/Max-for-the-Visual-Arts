...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 100.0, 492.0, 35.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 433.0, 40.0, 49.0, 20.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "GLgridshape - cull face", "set the front-facing or back-facing area" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 326.0, 133.0, 38.0, 22.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 11.0, 297.0, 110.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 331.0, 229.0, 130.0, 102.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape @shape sphere @lighting_enable 1 @smooth_shading 1 @dim 40 40 @blend_enable 1 @layer 1 @cull_face 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 217.0, 75.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 193.0, 187.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 193.0, 159.0, 247.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix 4 char 256 256 @planemap 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 193.0, 133.0, 129.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 193.0, 74.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 193.0, 106.0, 135.0, 22.0 ],
					"style" : "",
					"text" : "jit.noise 1 char 256 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.0, 250.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.0, 110.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 79.0, 141.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 366.0, 167.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 11.0, 321.0, 104.0, 35.0 ],
					"style" : "",
					"text" : "jit.window sphere @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 141.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 78.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 12.0, 110.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 12.0, 181.0, 140.0, 62.0 ],
					"style" : "",
					"text" : "jit.gl.render @erase_color 1. 1. 1. 1. @camera 0. 0. 4. @depth_enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 193.0, 229.0, 132.0, 116.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape @shape sphere @lighting_enable 1 @smooth_shading 1 @dim 40 40 @blend_enable 1 @depth_enable 0 @layer 2 @cull_face 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 72.0, 148.147247, 286.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 88.5, 171.0, 21.5, 171.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 202.5, 218.0, 340.5, 218.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 59.5, 171.0, 21.5, 171.0 ],
					"source" : [ "obj-6", 1 ]
				}
