...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLsketch - assemble", "use jit.gl.sketch to assemble multiple jit.gl.gridshape together." ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 70.0, 191.0, 22.0 ],
					"style" : "",
					"text_width" : 63.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 88.0, 191.0, 22.0 ],
					"style" : "",
					"text_width" : 63.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 106.0, 191.0, 22.0 ],
					"style" : "",
					"text_width" : 68.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 160.0, 96.0, 35.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 6.0, 242.0, 110.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 8.0, 8.0, 407.0, 24.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 482.0, 285.0, 154.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 187.0, 412.0, 40.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 232.0, 439.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 187.0, 438.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 141.0, 439.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 96.0, 438.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 50.0, 439.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 4.0, 6.0, 438.0, 40.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 358.0, 285.0, 118.0, 24.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 265.638458, 119.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 197.0, 96.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 141.0, 416.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 162.0, 241.0, 88.0, 24.0 ],
					"style" : "",
					"text" : "jit.gl.sketch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 62.0, 134.147247, 247.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
