...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLmesh - transparency", "see the transparency in a mesh, by changing the drawing order (use rotatexyz here)" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.5, 268.0, 64.0, 24.0 ],
					"style" : "",
					"text" : "visible"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.25, 239.0, 164.0, 24.0 ],
					"style" : "",
					"text" : "transparency is not visible"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 132.0, 96.0, 24.0 ],
					"style" : "",
					"text" : "transparency"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 271.0, 113.0, 22.0 ],
					"style" : "",
					"text" : "rotatexyz -166 39 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 242.0, 103.0, 22.0 ],
					"style" : "",
					"text" : "rotatexyz 12 39 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 199.0, 286.0, 22.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 21.0, 75.0, 58.0, 20.0 ],
									"style" : "",
									"text" : "jit.pack 3"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.0, 44.0, 97.0, 20.0 ],
									"style" : "",
									"text" : "jit.unpack 4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.0, 110.0, 25.0, 25.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 173.0, 122.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.0, 134.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 161.0, 129.0, 22.0 ],
					"style" : "",
					"text" : "pak color 1 1 0.5 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 173.0, 308.0, 336.0, 35.0 ],
					"style" : "",
					"text" : "jit.gl.mesh @color 0.5 0.5 0.5 0.67 @blend_enable 1 @draw_mode triangle_strip_adjacency @rotatexyz -166 39 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 173.0, 65.0, 198.0, 49.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape @dim 23 6 @matrixoutput 1 @blend_enable 1 @color 1. 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 226.0, 56.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 297.0, 109.0, 35.0 ],
					"style" : "",
					"text" : "jit.window mesh-tr @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 185.0, 141.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 59.0, 152.147247, 282.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
