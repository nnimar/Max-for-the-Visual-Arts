...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 13.0, 96.0, 32.5, 20.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 12.0, 111.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 13.0, 63.0, 172.0, 20.0 ],
									"text" : "unpack coords 0 0 0 1440 900"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 37.0, 66.0, 20.0 ],
									"text" : "jit.displays"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 123.0, 77.0, 20.0 ],
									"text" : "prepend dim"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 189.0, 63.0, 197.0, 33.0 ],
									"text" : "resample the waveform, in this case to the width of your screen."
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 144.899994, 89.0, 22.5, 89.0 ],
									"source" : [ "obj-10", 4 ]
								}
...
,
					"patching_rect" : [ 22.0, 392.0, 91.0, 20.0 ],
...
,
					"patching_rect" : [ 365.0, 192.662506, 110.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 31.0, 202.0, 21.0 ],
					"text" : "show buffer~ data in OpenGL.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 365.0, 218.0, 98.0, 33.0 ],
					"text" : "jit.window buffer @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 365.0, 64.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 365.0, 95.0, 58.0, 20.0 ],
					"text" : "qmetro 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 365.0, 124.0, 57.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 365.0, 162.0, 70.0, 20.0 ],
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.0, 417.0, 191.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 419.0, 254.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 7.0, 460.0, 472.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 315.0, 79.0, 18.0 ],
					"text" : "outputlast $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 7.0, 286.0, 75.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 315.0, 44.0, 18.0 ],
					"text" : "output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 249.0, 131.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 251.0, 102.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 7.0, 216.0, 49.0, 20.0 ],
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 78.0, 216.0, 49.0, 20.0 ],
					"text" : "* 0.001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 121.0, 115.0, 18.0 ],
					"text" : "read jongly.aif 0. -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 62.0, 139.0, 18.0 ],
					"text" : "read drumLoop.aif 0. -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 91.0, 129.0, 18.0 ],
					"text" : "read rainstick.aif 0. -1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 186.0, 113.5, 20.0 ],
					"text" : "info~ #0_buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 7.0, 152.0, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 352.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.0, 58.0, 124.147247, 199.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 3.0, 480.0, 51.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 73.5, 344.0, 16.5, 344.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 110.5, 179.5, 16.5, 179.5 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 412.5, 151.5, 374.5, 151.5 ],
					"source" : [ "obj-51", 1 ]
				}
