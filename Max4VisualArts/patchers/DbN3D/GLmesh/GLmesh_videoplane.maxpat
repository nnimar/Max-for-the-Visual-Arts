...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLmesh - videoplane", "generate coordinates for a video using a jit.expr" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 167.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.0, 276.0, 109.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 215.0, 90.0, 20.0 ],
					"style" : "",
					"text" : "or gen (norm) :"
				}
...
,
					"patching_rect" : [ 527.0, 33.0, 47.0, 20.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 25.0, 17.0, 38.0, 22.0 ],
									"style" : "",
									"text" : "norm"
								}
...
,
					"patching_rect" : [ 435.0, 215.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 335.0, 332.0, 22.0 ],
					"style" : "",
					"text_width" : 104.0
				}
...
,
					"patching_rect" : [ 12.0, 221.0, 110.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 62.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 157.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 62.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 200.0, 279.0, 132.0, 38.0 ],
					"rows" : 2,
					"vscroll" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 249.0, 87.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 170.0, 215.0, 173.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 115.0, 195.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 170.0, 188.0, 158.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix coord 2 float32 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 62.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "read dozer.mov"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 360.0, 89.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "jit.qt.movie"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 115.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 89.0, 161.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix vertex 3 float32 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 12.0, 246.0, 103.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 128.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 12.0, 192.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 365.0, 302.0, 24.0 ],
					"style" : "",
					"text" : "jit.gl.mesh @tex_map 0 @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 60.0, 123.147247, 227.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 369.5, 142.5, 144.5, 142.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 156.5, 21.5, 156.5 ],
					"source" : [ "obj-8", 2 ]
				}
