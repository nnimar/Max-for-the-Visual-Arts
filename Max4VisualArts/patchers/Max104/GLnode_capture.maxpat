...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLnode_capture (c74)", "nodes can capture to texture" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 337.0, 165.0, 205.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 221.0, 186.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 216.0, 105.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 59.0, 211.0, 22.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 7.0, 184.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 254.0, 208.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 337.0, 193.0, 195.0, 35.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape @shape sphere @material mtl2 @scale 0.2 0.2 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 135.0, 86.0, 317.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.node @capture 1 @dim 1024 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.0, 286.0, 279.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.material @name mtl2 @specular_model ward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 284.0, 119.0, 226.0, 35.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape @shape torus @material mtl2 @scale 0.5 0.5 0.5 @dim 40 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.0, 209.0, 102.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.0, 153.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 120.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 57.0, 120.147247, 193.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 186.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 0."
				}
