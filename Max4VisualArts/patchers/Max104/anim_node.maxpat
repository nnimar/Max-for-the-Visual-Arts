...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "pivot points with anim.node (c74)", "animate multiple gridshapes in relation to each other" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 0.0, 0.0, 574.5, 56.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 500.5, 123.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 648.0, 500.5, 52.0, 21.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 500.5, 83.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.5, 339.0, 247.0, 24.0 ],
					"style" : "",
					"text" : "animate blue and red (turn around X axis)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.5, 229.5, 215.0, 24.0 ],
					"style" : "",
					"text" : "ui-mapping dictionary (double click)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 183.0, 67.0, 34.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 120.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 10.0, 95.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 655.0, 418.5, 82.0, 24.0 ],
					"style" : "",
					"text" : "pivot (red)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 464.0, 451.75, 233.0, 23.0 ],
					"style" : "default",
					"text" : "jit.gl.gridshape @color 1 0 0 @axes 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 464.0, 420.5, 194.0, 23.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.5, 419.5, 135.0, 24.0 ],
					"style" : "",
					"text" : "dynamic node (blue)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.5, 262.0, 257.0, 24.0 ],
					"style" : "",
					"text" : "animated blue and red (turn around X axis)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.5, 149.0, 129.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 119.0, 102.0, 24.0 ],
					"style" : "",
					"text" : "root node (all)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 90.5, 200.0, 22.0 ],
					"style" : "",
					"text_width" : 75.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 63.5, 200.0, 22.0 ],
					"style" : "",
					"text_width" : 75.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 142.0, 121.0, 315.0, 23.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 305.5, 200.0, 22.0 ],
					"style" : "",
					"text_width" : 75.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 179.0, 264.5, 163.0, 23.0 ],
					"style" : "default",
...
,
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 179.0, 339.75, 90.0, 23.0 ],
					"style" : "default",
					"text" : "jit.anim.node"
				}
...
,
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 179.0, 420.5, 204.0, 23.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 162.0, 151.0, 202.0, 23.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 179.0, 451.75, 275.0, 23.0 ],
					"style" : "default",
					"text" : "jit.gl.gridshape @shape cube @color 0 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 162.0, 182.25, 273.0, 23.0 ],
					"style" : "default",
					"text" : "jit.gl.gridshape @shape cube @color 1 1 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.0, 250.5, 124.0, 35.0 ],
					"style" : "",
					"text" : "jit.window anim-pivot @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 388.75, 200.0, 22.0 ],
					"style" : "",
					"text_width" : 75.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.0, 232.5, 100.0, 22.0 ],
					"style" : "",
					"text_width" : 72.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 62.0, 130.147247, 229.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 188.5, 376.375, 473.5, 376.375 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 151.5, 309.875, 188.5, 309.875 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 59.5, 147.0, 19.5, 147.0 ],
					"source" : [ "obj-4", 1 ]
				}
