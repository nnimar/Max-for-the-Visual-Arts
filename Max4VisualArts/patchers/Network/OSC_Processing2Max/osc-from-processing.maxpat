...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "OSC from processing", "receives osc from processing" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 0.0, 0.0, 336.0, 52.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 180.5, 100.0, 22.0 ],
					"style" : "",
					"text" : "osc_to_Max.pde"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 180.5, 82.0, 22.0 ],
					"style" : "",
					"text" : "imi.docloader"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 126.0, 60.0, 20.0 ],
									"style" : "",
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 50.0, 152.0, 38.0, 20.0 ],
									"style" : "",
									"text" : "shell"
								}
...
,
					"patching_rect" : [ 261.0, 155.0, 45.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 172.0, 19.0, 20.0 ],
					"style" : "",
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 172.0, 19.0, 20.0 ],
					"style" : "",
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 97.0, 170.0, 56.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 170.0, 56.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 93.0, 109.0, 24.0 ],
					"style" : "",
					"text" : "OSC-route /test"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0, 129.0, 88.0, 24.0 ],
					"style" : "",
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 62.0, 115.0, 24.0 ],
					"style" : "",
