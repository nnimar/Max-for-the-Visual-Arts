...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLcornerpin+ (digitalFX)", "render GL object to GL cornerpin, you need to capture the texture via a node" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.0, 112.0, 94.0, 24.0 ],
					"style" : "",
					"text" : "auto-rotate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 286.0, 212.0, 23.0 ],
					"style" : "",
					"text_width" : 120.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 244.0, 198.0, 37.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 75.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 160.0, 45.0, 21.0 ],
					"style" : "",
					"text" : "s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 11.0, 210.0, 80.0, 34.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 11.0, 184.0, 110.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.render corners"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.0, 122.0, 71.0, 21.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.0, 95.0, 63.0, 21.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 207.0, 194.0, 24.0 ],
					"style" : "",
					"text" : "\"scene\" is rendered to the node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 183.0, 104.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.0, 115.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "0., 360. 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 289.0, 139.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "bline 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 160.0, 139.0, 80.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 209.0, 303.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.gridshape scene @shape torus @position 0. 0. -3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 159.0, 318.0, 220.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.cornerpin corners @drawcorners 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 159.0, 253.0, 252.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 319.0, 107.0, 35.0 ],
					"style" : "",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 329.5, 171.0, 409.0, 171.0, 409.0, 106.0, 312.5, 106.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 298.5, 170.5, 190.5, 170.5 ],
					"source" : [ "obj-10", 0 ]
				}
