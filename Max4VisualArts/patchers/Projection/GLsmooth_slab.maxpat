...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GL simple video (smooth)", "an efficient way to play video data using the GPU - this version works on Mac only" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 451.0, 302.5, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 479.0, 95.5, 79.0, 17.0 ],
					"style" : "",
					"text" : "video_twoscreens",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 451.0, 302.5, 112.0, 20.0 ],
					"style" : "",
					"text" : "load video_twoscreens"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.348022, 74.251862, 99.5, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.348022, 73.251862, 62.0, 20.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 297.348022, 73.251862, 81.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 168.0, 170.0, 23.0 ],
					"style" : "",
					"text" : "jit.gl.slab @colormode uyvy"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 302.5, 86.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 274.0, 279.5, 79.0, 17.0 ],
					"style" : "",
					"text" : "GLsmooth+",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"texton" : "Stop",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 302.5, 84.0, 20.0 ],
					"style" : "",
					"text" : "load GLsmooth+"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.0, 302.5, 116.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.0, 302.5, 91.0, 20.0 ],
					"style" : "",
					"text" : "load GLslab-gpu+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 302.5, 52.0, 21.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 161.0, 251.0, 37.0 ],
					"style" : "",
					"text" : "uyvy mode reduces the memory size of the image by half (uses apple conversion) "
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 118.0, 276.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 74.0, 32.5, 21.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 74.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.0, 74.0, 34.0, 21.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 74.0, 43.0, 21.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
,
					"patching_rect" : [ 10.0, 256.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 158.0, 45.0, 21.0 ],
					"style" : "",
					"text" : "s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.574097, 281.638458, 110.425903, 35.0 ],
					"style" : "",
					"text" : "jit.window smooth @depthbuffer 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.0, 211.0, 68.0, 34.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 12.0, 185.0, 68.0, 21.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 123.0, 71.0, 21.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 12.0, 95.0, 63.0, 21.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 60.0, 121.147247, 262.5 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 217.0, 358.0, 23.0 ],
					"style" : "",
					"text_width" : 117.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 134.0, 249.0, 219.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 451.0, 302.5, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 73.5, 149.0, 21.5, 149.0 ],
					"source" : [ "obj-3", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 305.848022, 102.125931, 143.5, 102.125931 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 197.5, 102.0, 143.5, 102.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 234.5, 102.0, 143.5, 102.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 269.5, 102.0, 143.5, 102.0 ],
					"source" : [ "obj-9", 0 ]
				}
