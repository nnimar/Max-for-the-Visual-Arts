...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLgridshape > GLmesh > GLmultiple", "draw one 3D shape and multiply it in space using a matrix (GLgridshape)" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.0, 165.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.handle"
				}
...
,
					"patching_rect" : [ 538.0, 32.0, 48.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 126.333344, 420.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "list", "", "", "" ],
									"outmode" : 2,
									"patching_rect" : [ 50.0, 130.0, 184.0, 62.0 ],
									"rowheight" : 20,
									"rows" : 7,
									"savemode" : 1,
									"selsync" : 0,
...
,
					"patching_rect" : [ 309.0, 517.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 12.0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "list", "", "", "" ],
									"outmode" : 2,
									"patching_rect" : [ 9.0, 83.0, 892.0, 143.0 ],
									"rowheight" : 20,
									"rows" : 7,
									"savemode" : 1,
									"selsync" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 9.0, 51.0, 89.0, 20.0 ],
									"style" : "",
									"text" : "imi.matrix2cell"
								}
...
,
					"patching_rect" : [ 142.0, 488.0, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 12.0,
...
,
					"patching_rect" : [ 11.0, 222.0, 110.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 11.0, 249.0, 110.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 317.0, 18.0, 20.0 ],
					"style" : "",
					"text" : "z"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 317.0, 18.0, 20.0 ],
					"style" : "",
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 317.0, 18.0, 20.0 ],
					"style" : "",
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 380.0, 142.0, 22.0 ],
					"style" : "",
					"text" : "setcell3d 8. 6. 0. 4. 3. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 146.5, 129.0, 105.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 332.583344, 317.0, 32.5, 21.0 ],
					"style" : "",
					"text" : "- 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 384.666656, 317.0, 32.5, 21.0 ],
					"style" : "",
					"text" : "- 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 294.333344, 420.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.333344, 458.0, 132.0, 22.0 ],
					"style" : "",
					"text" : "setall 0.1 0.1 0.1, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 294.333344, 488.0, 156.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix scale 3 float32 9 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 461.833374, 420.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 461.833374, 458.0, 121.0, 22.0 ],
					"style" : "",
					"text" : "jit.noise 4 float32 9 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.333344, 347.0, 329.0, 22.0 ],
					"style" : "",
					"text" : "pak setcell3d f f 0. f f 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 151.0, 217.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 178.0, 317.0, 32.5, 21.0 ],
					"style" : "",
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 229.666687, 317.0, 32.5, 21.0 ],
					"style" : "",
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 151.0, 270.0, 46.0, 21.0 ],
					"style" : "",
					"text" : "Uzi 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 151.0, 244.0, 98.0, 21.0 ],
					"style" : "",
					"text" : "Uzi 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 146.5, 158.0, 187.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 126.333344, 458.0, 125.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix 3 float32 9 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 126.333344, 546.0, 355.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 11.0, 191.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.0, 93.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 146.5, 86.0, 270.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 173.0, 216.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 239.5, 316.0, 239.166687, 316.0 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 239.5, 281.5, 394.166656, 281.5 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.833344, 506.0, 135.833344, 506.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 187.5, 300.5, 342.083344, 300.5 ],
					"source" : [ "obj-44", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 187.5, 316.0, 187.5, 316.0 ],
					"source" : [ "obj-44", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.833344, 410.0, 471.333374, 410.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.833344, 410.0, 303.833344, 410.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.833344, 373.0, 272.5, 373.0 ],
					"source" : [ "obj-48", 0 ]
				}
