...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLmultiple using texcoords (Robert Ramirez)", "texcoords of a texture displayed on jit.gl.multiple objects" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 0.0, 0.0, 525.0, 56.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 863.0, 304.0, 50.0, 39.0 ],
					"style" : "",
					"text" : "texture"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 310.0, 79.0, 39.0 ],
					"style" : "",
					"text" : "tex_plane_t"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 522.0, 310.0, 79.0, 39.0 ],
					"style" : "",
					"text" : "tex_plane_s"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 239.0, 41.0, 39.0 ],
					"style" : "",
					"text" : "scale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 265.0, 53.0, 39.0 ],
					"style" : "",
					"text" : "position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 173.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "camera 0 0 8"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 65.0, 23.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 132.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 102.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 253.0, 140.0, 35.0 ],
					"style" : "",
					"text" : "jit.window mult-texcoord @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 200.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 165.0, 63.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 123.0, 292.0, 22.0 ],
					"style" : "",
					"text" : "read http://lumina.sourceforge.net/pictures/font1.png"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 846.0, 346.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "setall 0, bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 846.0, 372.0, 102.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.0, 187.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "setall 0.2, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 676.0, 275.0, 159.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 506.0, 275.0, 157.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 676.0, 245.0, 138.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 506.0, 245.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix 4 float32 16 16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 145.0, 146.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 165.0, 187.0, 138.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 165.0, 217.0, 97.0, 49.0 ],
					"style" : "",
					"text" : "jit.expr @expr snorm[0]*3.1 snorm[1]*3.1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 165.0, 88.0, 21.0, 21.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 335.0, 217.0, 115.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 165.0, 432.0, 223.0, 55.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 402.0, 700.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.multiple 5 @glparams position scale tex_plane_s tex_plane_t texture @texture tex1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 58.0, 148.147247, 235.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 176.5, 344.5, 176.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 114.5, 193.5, 114.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 176.5, 855.5, 176.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 176.5, 515.5, 176.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 176.5, 685.5, 176.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 63.5, 161.0, 18.5, 161.0 ],
					"source" : [ "obj-5", 1 ]
				}
