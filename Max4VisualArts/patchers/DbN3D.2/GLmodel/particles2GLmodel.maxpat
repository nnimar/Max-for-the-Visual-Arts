...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLmodel - particles (c74)", "use GLmodel and GLmultiple with particles (shiva and vishnu)" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 329.0, 153.0, 37.0 ],
					"style" : "",
					"text" : "toggle this off and on to improve performance"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 243.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 234.0, 273.0, 116.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 373.0, 261.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.model @file duck.dae @material_mode 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 176.0, 303.0, 77.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 210.0, 167.0, 22.0 ],
					"style" : "",
					"text" : "jit.pack 1 @offset 2 @jump 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 61.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 180.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix pmat1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 150.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "jit.p.vishnu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 90.0, 179.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix pmat1 5 float32 100 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 176.0, 120.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "jit.p.shiva"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 337.0, 127.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 226.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 298.0, 107.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 98.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 2"
				}
...
,
					"patching_rect" : [ 8.0, 273.0, 110.0, 22.0 ],
