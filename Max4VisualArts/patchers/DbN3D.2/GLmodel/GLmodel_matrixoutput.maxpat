...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLmodel - matrixoutput", "use matrixoutput to morph between model shapes'" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 60.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 299.0, 58.0, 122.0, 24.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 9.0, 204.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.0, 124.0, 358.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.model @file mushrooms.obj @drawgroup 2 @matrixoutput 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 214.0, 95.0, 358.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.model @file mushrooms.obj @drawgroup 1 @matrixoutput 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 233.0, 214.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 233.0, 238.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 213.5, 156.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "jit.xfade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 213.5, 184.0, 216.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 213.5, 267.0, 232.0, 35.0 ],
					"style" : "",
					"text" : "jit.gl.mesh @draw_mode triangles @lighting_enable 1 @smooth_shading 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 228.5, 111.0, 35.0 ],
					"style" : "",
					"text" : "jit.window modmat @fsmenubar 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 154.5, 145.0, 35.0 ],
					"style" : "",
					"text" : "jit.gl.render @erase_color 0.5 0.8 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 118.5, 57.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 92.5, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 61.5, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 60.0, 98.0, 22.0 ],
					"style" : "",
					"text_width" : 56.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 57.0, 153.147247, 212.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 176.5, 136.5, 223.0, 136.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 56.5, 146.0, 18.5, 146.0 ],
					"source" : [ "obj-29", 1 ]
				}
