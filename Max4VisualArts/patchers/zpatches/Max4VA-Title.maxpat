...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 91.0, 52.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 197.0, 158.0, 22.0 ],
									"style" : "",
									"text" : "if $i1 == 1 then 449 else $i2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 324.0, 156.0, 22.0 ],
									"style" : "",
									"text" : "patching_rect $1 314 33 18"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 80.0, 293.0, 35.0, 22.0 ],
									"style" : "",
									"text" : "* 5.8"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 280.0, 507.0, 32.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2.0, 280.0, 646.0, 53.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "strlen.js",
				"bootpath" : "~/Documents/Max 7/Packages/Max for the Visual Arts/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
