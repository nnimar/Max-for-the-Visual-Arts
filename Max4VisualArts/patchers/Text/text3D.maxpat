...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.0, 288.0, 95.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 349.5, 368.0, 79.0, 17.0 ],
					"rounded" : 20.0,
					"text" : "IMI_type_text",
					"texton" : "Stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 288.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 288.0, 92.0, 16.0 ],
					"text" : "load IMI_type_text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.0, 181.0, 187.0, 20.0 ],
					"text_width" : 57.0
				}
...
,
					"patching_rect" : [ 169.0, 76.0, 92.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 181.0, 189.0, 20.0 ],
					"text_width" : 64.0
				}
...
,
					"patching_rect" : [ 7.574097, 288.0, 181.425903, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 481.5, 288.0, 118.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.5, 288.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.5, 288.0, 109.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.5, 75.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
,
					"patching_rect" : [ 8.0, 200.0, 110.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 190.0, 106.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.574097, 226.0, 104.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "a simple intro to jit.gl.text3d",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.5, 102.0, 43.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.5, 132.0, 96.0, 18.0 ],
					"text" : "color 1. 1. 1. $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 462.5, 75.0, 82.0, 20.0 ],
					"text" : "loadmess 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 169.0, 228.0, 375.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 122.0, 60.0, 20.0 ],
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 8.0, 94.0, 68.0, 20.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 160.0, 70.0, 20.0 ],
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 133.0, 160.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.5, 132.0, 97.0, 18.0 ],
					"text" : "blend_enable $1"
				}
