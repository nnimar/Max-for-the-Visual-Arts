...
,
					"patching_rect" : [ 11.0, 304.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 3.0, 343.0, 31.0 ],
					"text" : "Gen_vignette",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 827.0, 59.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 351.0, 70.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 827.0, 11.0, 109.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 351.0, 22.0, 109.0, 48.0 ],
					"text" : "Zoom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 216.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 96.0, 183.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 203.0, 249.0, 51.0, 20.0 ],
					"text" : "jit.gl.pix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 110.0, 103.0, 18.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 110.0, 22.0, 77.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 203.0, 154.0, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 203.0, 286.0, 217.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 110.0, 44.0, 20.0 ],
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.0, 253.0, 80.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 140.0, 113.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 11.0, 332.0, 108.0, 20.0 ],
					"text" : "jit.window vignette"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 12.0, 208.0, 127.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 167.0, 46.0, 20.0 ],
					"text" : "s draw"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 136.0, 87.0, 20.0 ],
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 70.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 11.0, 53.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 12.0, 105.0, 65.0, 20.0 ],
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 194.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 74.0, 183.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 61.0, 142.147247, 301.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 4.0, 497.0, 51.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 89.5, 195.0, 21.5, 195.0 ],
					"source" : [ "obj-27", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 261.5, 140.5, 212.5, 140.5 ],
					"source" : [ "obj-32", 0 ]
				}
