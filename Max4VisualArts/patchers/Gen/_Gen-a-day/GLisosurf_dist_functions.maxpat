...
,
					"patching_rect" : [ 7.0, 215.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "GLisosurf - dist. functions", "an application to distance functions" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 371.0, 401.0, 20.0 ],
					"style" : "",
					"text" : "see: http://www.iquilezles.org/www/articles/distfunctions/distfunctions.htm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 289.0, 150.0, 22.0 ],
					"style" : "",
					"text_width" : 76.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 269.0, 150.0, 22.0 ],
					"style" : "",
					"text_width" : 76.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 71.0, 278.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 205.25, 220.0, 113.5, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 147.0, 184.0, 155.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix 1 float32 64 64 64"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 145.0, 43.0, 20.0 ],
									"style" : "",
									"text" : "max 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 177.0, 43.0, 20.0 ],
									"style" : "",
									"text" : "length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 113.0, 32.5, 20.0 ],
									"style" : "",
									"text" : "-"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 145.0, 45.0, 115.0, 20.0 ],
									"style" : "",
									"text" : "param b 0.2 0.2 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 73.0, 30.0, 20.0 ],
									"style" : "",
									"text" : "abs"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 45.0, 44.0, 20.0 ],
									"style" : "",
									"text" : "snorm"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.0, 215.0, 37.0, 20.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 147.0, 220.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 147.0, 324.0, 230.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.isosurf @epsilon -0.05 @isolevel 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 7.0, 245.0, 121.0, 22.0 ],
					"style" : "",
					"text" : "jit.window dist_func2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 184.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.render"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 6.0, 122.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "t b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 6.0, 92.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 33"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 159.0, 156.5, 159.0 ],
					"source" : [ "obj-4", 0 ]
				}
