...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "video mask with scalebias", "scale (multiply) and bias (add to) each an input matrix (ARGB) to achieve a variety of color effects." ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 1.0, -2.0, 572.0, 55.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 566.0, 338.0, 107.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 567.0, 291.0, 79.0, 17.0 ],
					"style" : "",
					"text" : "Gen_scalebias",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 341.0, 116.0, 21.0 ],
					"style" : "",
					"text" : "load Gen_scalebias"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 338.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.0, 241.0, 157.0, 22.0 ],
					"style" : "",
					"text_width" : 59.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 459.5, 338.0, 99.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.5, 338.0, 116.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 94.0, 121.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.0, 71.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "loadmess 13"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 366.0, 94.0, 81.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 163.0, 72.0, 37.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 150.0, 54.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 175.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "param bias $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.0, 150.0, 54.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 175.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "param scale $1"
				}
...
,
					"patching_rect" : [ 8.0, 218.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 123.0, 58.0, 24.0 ],
					"style" : "",
					"text" : "backg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 80.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 160.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 491.5, 90.5, 58.0, 24.0 ],
					"style" : "",
					"text" : "mask"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 350.0, 211.0, 175.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 350.0, 120.0, 124.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 350.0, 269.0, 199.5, 49.0 ],
					"style" : "",
					"text" : "jit.gl.videoplane @position 0. 0. 0. @blend_enable 1 @blend multiply @layer 2 @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 126.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "read dozer.mov"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 146.0, 152.0, 124.0, 22.0 ],
					"style" : "",
					"text" : "jit.qt.movie @adapt 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 146.0, 182.0, 145.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.videoplane @layer 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 124.0, 95.0, 22.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 8.0, 98.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 8.0, 243.0, 116.0, 22.0 ],
					"style" : "",
					"text" : "jit.window scalebias"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 62.0, 119.0, 209.0 ],
					"proportion" : 0.39,
					"rounded" : 30,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.0, 338.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 155.5, 110.0, 359.5, 110.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 386.5, 201.5, 359.5, 201.5 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 489.5, 201.5, 359.5, 201.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 93.5, 151.0, 17.5, 151.0 ],
					"source" : [ "obj-6", 2 ]
				}
