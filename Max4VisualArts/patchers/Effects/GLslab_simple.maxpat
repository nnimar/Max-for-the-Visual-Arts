...
,
		"classnamespace" : "box",
		"rect" : [ 100.0, 125.0, 580.0, 341.0 ],
		"gridsize" : [ 15.0, 15.0 ],
		"bottomtoolbarpinned" : 1,
		"toolbars_unpinned_last_save" : 7,
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "GLslab - simple", "performs a GL accelerated grid-based evaluation using a shader" ],
					"bgmode" : 1,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 214.0, 68.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 67.0, 43.0, 21.0 ],
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 163.0, 45.0, 21.0 ],
					"text" : "s bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 266.0, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 265.0, 67.0, 34.0 ],
					"text" : "scale bias image"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 281.0, 105.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.0, 239.0, 87.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.0, 160.0, 74.0, 21.0 ],
					"text" : "getparamlist"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.0, 134.0, 50.0, 21.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.0, 160.0, 90.0, 21.0 ],
					"text" : "param scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 472.0, 134.0, 50.0, 21.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 160.0, 84.0, 21.0 ],
					"text" : "param bias $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 160.0, 118.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 304.0, 252.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 67.0, 116.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 67.0, 30.0, 21.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 67.0, 31.0, 21.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 165.0, 107.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 207.0, 126.0, 24.0 ],
					"text" : "jit.gl.slab",
					"textfile" : 					{
						"filename" : "cc.scalebias.jxs",
						"flags" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 10.0, 96.0, 61.0, 21.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 126.0, 67.0, 21.0 ],
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 61.0, 120.147246999999993, 260.0 ],
					"proportion" : 0.39,
					"rounded" : 30
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 388.5, 190.0, 174.5, 190.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 481.5, 190.0, 174.5, 190.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 190.5, 190.0, 174.5, 190.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-37", 0 ],
					"midpoints" : [ 221.5, 96.0, 174.5, 96.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-37", 0 ],
					"midpoints" : [ 377.5, 96.0, 174.5, 96.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-37", 0 ],
					"midpoints" : [ 342.5, 96.0, 174.5, 96.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 311.5, 190.0, 174.5, 190.0 ],
					"source" : [ "obj-8", 0 ]
				}
