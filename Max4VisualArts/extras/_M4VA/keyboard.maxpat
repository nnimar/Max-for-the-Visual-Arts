...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, -278.0 ],
					"patching_rect" : [ 3.0, 1.0, 486.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3.0, 15.0, 159.0, 20.0 ],
					"style" : "",
					"text" : "loadmess read ascii_keyboard.gif"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3.0, 37.5, 858.0, 300.0 ],
					"pic" : "ascii_keyboard.gif"
				}
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../Shared/Max 7/Packages/Max4VisualArts/patchers/Sources/images",
				"type" : "GIFf",
				"implicit" : 1
			}
, 			{
